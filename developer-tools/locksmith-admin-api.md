...
* <mark style="color:green;">`POST`</mark> `/lock/` \
  Creates a lock. This operation is not yet fully supported, but [more in depth information can be found here](../more-developer-docs.../using-the-admin-api-with-locks.md).
