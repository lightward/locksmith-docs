...
* <mark style="color:green;">`POST`</mark> `/lock/` \
  Creates a lock. This operation is not yet fully supported, but [more in depth information can be found here](../more-dev-tool-docs.../creating-locks-with-the-admin-api-wip.md).
